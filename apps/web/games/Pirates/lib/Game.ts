...
// //   SHIP_SIZE,
// // } from './Constants';
// // import { PiratesProxy, QUANISATION_LEVEL } from 'zknoid-chain-dev';
// // class Ship {
...
// //     this.ship.turnRate = Math.max(
// //       (-MAX_TURN_RATE * 360) / QUANISATION_LEVEL,
// //       Math.min((MAX_TURN_RATE * 360) / QUANISATION_LEVEL, t)
// //     );
// //   }
// // }
...
// //   clock: Clock;
// //   player: Player;
// //   players:Record<string, PiratesProxy.ProxyShip> = {};
...
// //         intersects.length && this.onNewOffset(offset.x, offset.z);
// //       }
// //     }
...
// //         playerShip.getWorldPosition(player);
// //         const offset = intersects[0].point.sub(player);
// //         intersects.length && this.onNewOffsetFinal(offset.x, offset.z);
// //       }
// //     }
...
// //     // Implementation remains the same
// //   }
// //   onNewOffset(x: number, y: number) {
// //     // Implementation remains the same
// //   }
// //   onNewOffsetFinal(x: number, y: number) {
// //     // Implementation remains the same
// //   }
